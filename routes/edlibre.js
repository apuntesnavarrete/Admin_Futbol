...
const plantel_1 = await pool.query("SELECT * FROM `ed_general_libre_c22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `ed_general_libre_c22` WHERE Equipo = ?",[equipo_2]);
...
await pool.query("INSERT INTO libre_c2022_ed set ?",[Resul_1])
await pool.query("INSERT INTO libre_c2022_ed set ?",[Resul_2])
