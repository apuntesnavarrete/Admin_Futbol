...
const plantel_1 = await pool.query("SELECT * FROM `pro_general_sub21_a22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `pro_general_sub21_a22` WHERE Equipo = ?",[equipo_2]);
...
await pool.query("INSERT INTO Pro_sub21_a22 set ?",[Resul_1])
await pool.query("INSERT INTO Pro_sub21_a22 set ?",[Resul_2])
