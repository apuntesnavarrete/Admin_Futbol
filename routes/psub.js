...
const plantel_1 = await pool.query("SELECT * FROM `pro_general_sub22_c22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `pro_general_sub22_c22` WHERE Equipo = ?",[equipo_2]);
...
router.post('/actpsub' , async (req,res,next)=>{
...
await pool.query("INSERT INTO pro_sub21_c22 set ?",[Resul_1])
await pool.query("INSERT INTO pro_sub21_c22 set ?",[Resul_2])
...
res.redirect('http://localhost:8081/resul/pro/sub21')
})
