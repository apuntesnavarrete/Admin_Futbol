...
const plantel_1 = await pool.query("SELECT * FROM `g_general_mix_c22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `g_general_mix_c22` WHERE Equipo = ?",[equipo_2]);
...
await pool.query("INSERT INTO g_mixto_c22 set ?",[Resul_1])
await pool.query("INSERT INTO g_mixto_c22 set ?",[Resul_2])
