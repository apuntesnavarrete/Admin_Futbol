...
const plantel_1 = await pool.query("SELECT * FROM `G_general_sub19_a22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `G_general_sub19_a22` WHERE Equipo = ?",[equipo_2]);
...
router.post('/actgjuve' , async (req,res,next)=>{
...
await pool.query("INSERT INTO G_Sub19_a22 set ?",[Resul_1])
await pool.query("INSERT INTO G_Sub19_a22 set ?",[Resul_2])
...
res.redirect('http://localhost:8081/resul/gemelas/sub19')
})
