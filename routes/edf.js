...
const plantel_1 = await pool.query("SELECT * FROM `ed_general_fem_c22` WHERE Equipo = ?",[equipo]);
const plantel_2 = await pool.query("SELECT * FROM `ed_general_fem_c22` WHERE Equipo = ?",[equipo_2]);
...
router.post('/actfem' , async (req,res,next)=>{
...
await pool.query("INSERT INTO ed_femenil_c2022 set ?",[Resul_1])
await pool.query("INSERT INTO ed_femenil_c2022 set ?",[Resul_2])
